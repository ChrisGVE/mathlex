...
fn variable_to_latex(name: &str) -> String {
...
fn to_latex_literal(expr: &Expression) -> String {
    match expr {
...
fn to_latex_binary(op: &BinaryOp, left: &Expression, right: &Expression) -> String {
    match op {
        BinaryOp::Div => {
...
fn to_latex_unary(op: &UnaryOp, operand: &Expression) -> String {
...
fn to_latex_function(name: &str, args: &[Expression]) -> String {
    if name == "sqrt" {
...
fn to_latex_calculus(expr: &Expression) -> String {
    match expr {
...
fn indexed_symbol_to_latex(prefix: &str, indices: &[crate::ast::TensorIndex]) -> String {
...
fn to_latex_linear_algebra(expr: &Expression) -> String {
    match expr {
...
fn to_latex_logic_sets(expr: &Expression) -> String {
    match expr {
...
fn to_latex_relations(expr: &Expression) -> String {
    match expr {
