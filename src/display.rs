...
fn fmt_literal(expr: &Expression, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    match expr {
...
fn fmt_binary(expr: &Expression, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
fn fmt_unary(expr: &Expression, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
fn fmt_function(expr: &Expression, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
/// Format multiple-integral bodies, extracting the vars string and optional
/// bounds string. Used only by `fmt_calculus`.
...
fn fmt_calculus(expr: &Expression, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    match expr {
...
fn fmt_linear_algebra(expr: &Expression, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    match expr {
...
/// EmptySet, PowerSet.
fn fmt_logic_sets(expr: &Expression, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    match expr {
...
fn fmt_relations(expr: &Expression, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    match expr {
